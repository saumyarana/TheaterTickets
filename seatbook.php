...
extract($_POST);
$booked = [];
foreach (findall("booking", "mid='$mid' and bdate='$bdate' and tid='$tid' and sid='$sid'") as $r) {
            ...
            <div class="right" style="width:650px;float:right">
                <form name="ff" method="post" action="book.php">
                    ...
                    <div class="form-group form-row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" readonly="readonly" id="seatnums" required class="form-control" name="seatnums">
                        </div>
                    </div>
